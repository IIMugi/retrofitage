      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        {isLoading && (
          <div className="text-center py-8">
            ...
            <p className="mt-4 text-slate-500 dark:text-slate-400">Loading articles...</p>
          </div>
        )}
          ...
          <>
            <div className="relative mb-8">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 text-lg border-2 border-slate-200 dark:border-slate-700 rounded-xl bg-white dark:bg-slate-800 text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:border-primary-500 dark:focus:border-primary-400 transition-colors"
                autoFocus
              />
              {isSearching && (
                ...
                <div className="flex flex-wrap gap-2">
                  {suggestions.map((suggestion) => (
                    <button
                      ...
                      className="px-4 py-2 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-full hover:bg-primary-100 dark:hover:bg-primary-900/30 hover:text-primary-700 dark:hover:text-primary-300 transition-colors"
                    >
                      {suggestion}
                    </button>
                  ))}
              ...
              <div>
                ...
                <div className="space-y-6">
                  {results.map((result) => (
                    ...
                    >
                      <article className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6 hover:shadow-lg hover:border-primary-300 dark:hover:border-primary-600 transition-all">
            ...
            {!query && (
              <div className="text-center py-12">
                ...
                <p className="text-slate-500 dark:text-slate-400 max-w-md mx-auto">
                  Search our {allPosts.length} comprehensive guides on aging-in-place technology, home modifications, and senior safety solutions.
                </p>
              </div>
            )}
          </>
