        ...
        <ul className="space-y-4">
          {trending.map((post, index) => (
            <li key={post.slug}>
              ...
              >
                <span className="text-2xl font-bold text-slate-300 group-hover:text-primary-500 transition-colors">
                  {String(index + 1).padStart(2, '0')}
                </span>
                <span className="text-base text-slate-600 group-hover:text-primary-600 transition-colors leading-snug">
                  {post.title}
                </span>
              </Link>
            </li>
        ...
        <ul className="space-y-3">
          {highValue.map((post) => (
            <li key={post.slug}>
              ...
              >
                <span className="text-base text-slate-700 group-hover:text-primary-600 transition-colors font-medium">
                  {post.title}
                </span>
