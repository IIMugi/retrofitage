...
const footerLinks = {
  ...
  resources: [
    { name: 'Cost Calculators', href: '/resources/calculators' },
    { name: 'Contractor Directory', href: '/resources/contractors' },
    { name: 'Product Reviews', href: '/resources/reviews' },
    { name: 'Safety Checklist', href: '/resources/checklist' },
  ],
  company: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="text-slate-400 hover:text-white transition-colors" aria-label="Pinterest">
