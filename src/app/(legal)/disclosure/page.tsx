  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-slate-800 dark:text-white mb-2">Affiliate Disclosure</h1>
        ...
        <div className="prose prose-lg prose-slate dark:prose-invert max-w-none">
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">Our Commitment to Transparency</h2>
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">Amazon Associates Program</h2>
          <p className="text-slate-600 dark:text-slate-300">
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">Other Affiliate Partnerships</h2>
          <p className="text-slate-600 dark:text-slate-300">
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">How This Affects Our Content</h2>
          
          <h3 className="text-xl font-semibold text-slate-800 dark:text-white mt-6 mb-3">What We Promise:</h3>
          <ul className="list-disc pl-6 space-y-2 my-4 text-slate-600 dark:text-slate-300">
            <li>
          ...
          <h3 className="text-xl font-semibold text-slate-800 dark:text-white mt-6 mb-3">What We Will Not Do:</h3>
          <ul className="list-disc pl-6 space-y-2 my-4 text-slate-600 dark:text-slate-300">
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">Advertising (Google AdSense)</h2>
          <p className="text-slate-600 dark:text-slate-300">
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">Why We Use Affiliate Marketing</h2>
          <p className="text-slate-600 dark:text-slate-300">
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">Questions?</h2>
          <p className="text-slate-600 dark:text-slate-300">
          ...
          <div className="bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-xl p-6 mt-8">
            <h3 className="text-xl font-semibold text-primary-800 dark:text-primary-200 mb-2">Thank You</h3>
