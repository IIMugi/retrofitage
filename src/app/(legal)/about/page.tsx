  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-slate-800 dark:text-white mb-6">About RetrofitAge</h1>
        ...
        <div className="prose prose-lg prose-slate dark:prose-invert max-w-none">
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">Our Mission</h2>
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">Our Expertise</h2>
          <p className="text-slate-600 dark:text-slate-300">
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">Our Commitment</h2>
          <p className="text-slate-600 dark:text-slate-300">
          ...
          <p className="text-slate-600 dark:text-slate-300">
            ...
            <Link href="/contact" className="text-primary-600 dark:text-primary-400 hover:underline">Contact Page</Link>{' '}
          ...
          <div className="bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-lg p-6 mt-8">
            <h3 className="text-xl font-semibold text-primary-800 dark:text-primary-200 mb-2">Start Exploring</h3>
