    ...
    <div className="min-h-screen bg-white dark:bg-slate-900">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-lg prose-slate dark:prose-invert max-w-none">
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">1. Acceptance of Terms</h2>
          <p className="text-slate-600 dark:text-slate-300">
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">2. Description of Service</h2>
          <p className="text-slate-600 dark:text-slate-300">
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">3. Disclaimer of Warranties</h2>
          <p className="text-slate-600 dark:text-slate-300">
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">4. Professional Advice Disclaimer</h2>
          <p className="text-slate-600 dark:text-slate-300">
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">5. Product Recommendations and Affiliate Links</h2>
          <p className="text-slate-600 dark:text-slate-300">
            ...
            <Link href="/disclosure" className="text-primary-600 dark:text-primary-400 hover:underline">Affiliate Disclosure</Link>{' '}
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">6. Intellectual Property</h2>
          <p className="text-slate-600 dark:text-slate-300">
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">7. User Conduct</h2>
          <p className="text-slate-600 dark:text-slate-300">When using our Site, you agree not to:</p>
          <ul className="list-disc pl-6 space-y-2 my-4 text-slate-600 dark:text-slate-300">
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">8. Limitation of Liability</h2>
          <p className="text-slate-600 dark:text-slate-300">
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">9. Indemnification</h2>
          <p className="text-slate-600 dark:text-slate-300">
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">10. Third-Party Links</h2>
          <p className="text-slate-600 dark:text-slate-300">
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">11. Changes to Terms</h2>
          <p className="text-slate-600 dark:text-slate-300">
          ...
          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">12. Governing Law</h2>
          <p className="text-slate-600 dark:text-slate-300">
            These Terms shall be governed by and construed in accordance with the laws of the United States, 
            without regard to its conflict of law provisions.
          </p>

          <h2 className="text-2xl font-semibold text-slate-800 dark:text-white mt-8 mb-4">13. Contact Information</h2>
          <p className="text-slate-600 dark:text-slate-300">
            For questions about these Terms, please contact us at:{' '}
            <a href="mailto:legal@retrofitage.com" className="text-primary-600 dark:text-primary-400 hover:underline">
